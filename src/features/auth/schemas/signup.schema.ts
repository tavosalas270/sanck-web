...
// Tipo limpio para el contexto — solo las 3 credenciales
...
// Schema acumulativo para el resolver del form en el step 3
export const credentialsStepSchema = emailLinkSchema
  .extend({
    username: z
      .string()
      .min(5, 'Username must be at least 5 characters')
